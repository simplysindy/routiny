...
describe('SingleDayTaskDisplay', () => {
  ...
  it('should call onStepComplete when checkbox is clicked', async () => {
    ...
    render(<SingleDayTaskDisplay task={mockTask} onStepComplete={handleStepComplete} />);
  ...
  it('should not allow unchecking completed steps', async () => {
    ...
    render(
      <SingleDayTaskDisplay task={taskWithCompleted} onStepComplete={handleStepComplete} />
    );
  ...
  it('should show celebration message when all steps completed', () => {
    ...
    expect(screen.getByText(/Congratulations! You've completed all steps!/i)).toBeInTheDocument();
  });

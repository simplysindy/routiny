...
describe('MultiDayTaskDisplay', () => {
  ...
  it('should render current day tasks by default', () => {
    ...
    expect(screen.queryByText('Practice chord transitions')).not.toBeInTheDocument();
  });
  ...
  it('should call onStepComplete with correct day and stepIndex', async () => {
    ...
    render(<MultiDayTaskDisplay task={mockTask} onStepComplete={handleStepComplete} />);
  ...
  it('should show celebration message when all days completed', () => {
    ...
    expect(screen.getByText(/Amazing! You've completed all 3 days!/i)).toBeInTheDocument();
  });
  ...
  it('should not allow unchecking completed tasks', async () => {
    ...
    render(
      <MultiDayTaskDisplay task={taskWithCompleted} onStepComplete={handleStepComplete} />
    );
